...
int main(void)
{
    ...
    PointList points;
    std::ifstream stream("/Users/shadow/Desktop/Poisson_surface_reconstruction_3/data/kitten.xyz");
    if (!stream ||
    ...
    std::ofstream out("/Users/shadow/Desktop/Poisson_surface_reconstruction_3/data/kitten_poisson-20-30-0.375.off");
